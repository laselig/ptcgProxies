...
class advanced_card_search(Form):
	attack_text = StringField('Attack Text', validators=[DataRequired()])
	ability_text = StringField('Ability Text', validators=[DataRequired()])
